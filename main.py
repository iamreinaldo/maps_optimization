...
if __name__ == '__main__':
    ...
    enderecos = [
                ...
                'R. Antônio A Mesquita, 128 - Vila Feliz, Jacobina - BA, 44700-000', #Vila Yamana
                "Largo Monte Tabor, s/n - Caixa D'água, Jacobina - BA, 44100-700", #Hotel Serra do Ouro
                "Avenida Pau Ferro - Catuaba, Jacobina - BA, 44700-000", #Aeroporto
                "R. do Rosário, s/n - Bananeiras, Jacobina - BA, 44700-000" #Bananeira
                ]
